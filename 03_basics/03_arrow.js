...
// Implicit return : There is no need to use {} in the function in the first line. means we assum there is node to typed to add the return type.
// Example 2:
//   -- if we use the curly braces, there is ned of return type in code.
